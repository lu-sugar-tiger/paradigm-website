...
assert.match(rendererSource, /const touchZoom = image \? " data-media-zoom-touch" : "";[\s\S]*?class="product-card__media"\$\{touchZoom\}/, "shared product cards must opt in only when populated media exists");
