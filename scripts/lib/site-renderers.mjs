...
const MATERIAL_SYMBOLS_STYLESHEET = `https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght@400..700&icon_names=${[...new Set(Object.values(MATERIAL_ICON_NAMES))].sort().join(",")}&display=block`;
...
export function renderProductCard(product, root = "") {
  ...
  <div class="product-card__media" data-media-zoom-touch>${image}</div>
...
export function renderDocument({
  ...
  const baseStyles = ["tokens.css?v=20260831f", "motion.css?v=20260831a", "reset.css?v=20260829a", "base.css", "layout.css", "components.css?v=20260831h", "pages.css?v=20260829a", "color-options.css"];
  ...
  const scriptMarkup = ["app.js?v=20260831a", "search-core.js?v=20260829b", "search.js?v=20260831a", ...dataScripts, "choices.js?v=20260831c", ...interactionScripts].map((file) => `  <script defer src="${html(asset(root, `assets/js/${file}`))}"></script>`).join("\n");
