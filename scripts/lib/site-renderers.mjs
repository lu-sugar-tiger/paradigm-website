...
export function renderDocument({
  ...
  const baseStyles = ["tokens.css?v=20260901b", "motion.css?v=20260831a", "reset.css?v=20260829a", "base.css", "layout.css", "components.css?v=20260902d", "pages.css?v=20260829a", "color-options.css"];
  ...
  const scriptMarkup = ["app.js?v=20260831a", "search-core.js?v=20260829b", "search.js?v=20260901b", ...dataScripts, "choices.js?v=20260831c", ...interactionScripts].map((file) => `  <script defer src="${html(asset(root, `assets/js/${file}`))}"></script>`).join("\n");
