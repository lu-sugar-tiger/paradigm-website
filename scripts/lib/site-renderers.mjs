...
export function renderDocument({
  ...
  const baseStyles = ["tokens.css?v=20260831c", "reset.css?v=20260829a", "base.css", "layout.css", "components.css?v=20260831c", "pages.css?v=20260829a", "color-options.css"];
  ...
  const scriptMarkup = ["app.js?v=20260829b", "search-core.js?v=20260829b", "search.js?v=20260830c", ...dataScripts, "choices.js?v=20260829a", ...interactionScripts].map((file) => `  <script defer src="${html(asset(root, `assets/js/${file}`))}"></script>`).join("\n");
